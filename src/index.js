// Your code here
// while the page loads,  wait for the DOM content to be fully loaded.
document.addEventListener('DOMContentLoaded', () => {
    ...
    function createMovieItem(cinema) {
        ...
        //  add custom attribute to store the movie's ID.
        listItem.dataset.cinemaId = cinema.id;
        //  add CSS classes to style the list item.
        listItem.classList.add('movie', 'item');
        //  add click event listener to show details about the movie when clicked.
